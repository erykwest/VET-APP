...
drop policy if exists storage_clinical_documents_select_own on storage.objects;
create policy storage_clinical_documents_select_own
on storage.objects
for select
using (
...
drop policy if exists storage_clinical_documents_insert_own on storage.objects;
create policy storage_clinical_documents_insert_own
on storage.objects
for insert
with check (
    bucket_id = 'clinical-documents'
...
drop policy if exists storage_clinical_documents_update_own on storage.objects;
create policy storage_clinical_documents_update_own
on storage.objects
for update
using (
    bucket_id = 'clinical-documents'
...
drop policy if exists storage_clinical_documents_delete_own on storage.objects;
create policy storage_clinical_documents_delete_own
on storage.objects
for delete
using (
    bucket_id = 'clinical-documents'
